// Wiki language list: the single source of truth for wiki editions
// (values are Wikipedia language codes). Data-only module so stores can
// import it without pulling in React components (cycle safety).
export interface WikiLanguageEntry {
  readonly value: string; // WP language code
  readonly label: string;
  readonly isoCode: string; // ISO language code
}

export const LANGUAGES: readonly WikiLanguageEntry[] = [
