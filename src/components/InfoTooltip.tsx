  ...
  return (
    <Tooltip>
      ...
      <TooltipContent className="max-w-[400px] bg-white text-base shadow-lg dark:bg-dark-surface-secondary dark:text-dark-primary dark:shadow-dark-primary/10">
        <p>{t({ id: "All of the information is stored locally in your browser (because servers cost money)" })}</p>
        <p>{t({ id: "If you clear your browser data or switch to another browser all of your data will be gone" })}</p>
      </TooltipContent>
    </Tooltip>
  );
};
