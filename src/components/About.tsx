  ...
  return (
    <>
      ...
      <p className="pt-4 pb-8">
        The goal of the game is to navigate from a starting wikipedia article to
        another one, in the least amount of clicks and time.
      </p>
      <h3 className="border-b-[1px] border-secondary-border text-2xl">
        Features
      </h3>
      ...
      <Link
        to={"/settings"}
        className="bg-secondary-blue px-10 py-3 hover:bg-primary-blue"
      >
        Play
      </Link>
    </>
