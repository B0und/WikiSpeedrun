        ...
        >
          ...
          <Dialog.Close asChild>
            <button
              ...
              aria-label={t({ id: "Close", message: "Close", comment: "Button that closes the modal dialog" })}
            >
              <X />
            </button>
          </Dialog.Close>
