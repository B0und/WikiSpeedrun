...
const nl: Translation = {
  ...
  TIMER_DESCRIPTION: "Eerlijke timer met hoge precisie",
  TIMER_SUB_DESCRIPTION: "stopt eigenlijk terwijl u het volgende artikel laadt",
  SESSION_PROGRESS: "Houdt de voortgang van uw sessie bij",
  DARK_THEME: "Ondersteuning voor donkere thema's",
  ...
  CHEATING_ATTEMPTS: "Pogingen tot bedrog",
  RESULTS: "Resultaten",
  PLAY_AGAIN: "Speel opnieuw",
  GIVE_UP: "Geef op",
  CONFIRM_ACTION: "Bevestig actie",
  LEAVE_WARNING: "Als je weggaat, gaat je huidige voortgang verloren",
