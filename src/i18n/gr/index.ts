...
const gr: Translation = {
  ...
  "The goal of the game is to navigate from a starting wikipedia article to another one, in the least amount of clicks and time":
    "Ο στόχος του παιχνιδιού είναι να πλοηγηθείτε από ένα αρχικό άρθρο της Wikipedia σε ένα άλλο, με τα λιγότερα κλικ και χρόνο.",
  Features: "Χαρακτηριστικά",
  "Now supports multiple languages": "Υποστηρίζει πλέον πολλές γλώσσες",
  "No registration required": "Δεν απαιτείται εγγραφή",
  "High precision fair™ timer": "Χρονόμετρο υψηλής ακρίβειας fair™",
  "actually stops while you are loading the next article": "σταματά πραγματικά ενώ φορτώνετε το επόμενο άρθρο",
  "Keeps track of your session progress": "Παρακολουθεί την πρόοδο της συνεδρίας σας",
  ...
  "Start typing and then select values from the dropdown list or press the random button":
    "Ξεκινήστε να πληκτρολογείτε και στη συνέχεια επιλέξτε τιμές από την αναπτυσσόμενη λίστα ή πατήστε το κουμπί τυχαίας επιλογής.",
  "Select starting article": "Επιλέξτε αρχικό άρθρο",
  "Select ending article": "Επιλέξτε τελικό άρθρο",
  "Start typing to see options": "Ξεκινήστε να πληκτρολογείτε για να δείτε επιλογές",
  "Article clicks": "Κλικ άρθρων",
  "Cheating attempts": "Απόπειρες εξαπάτησης",
  Results: "Αποτελέσματα",
  "Play again": "Παίξε ξανά",
  "Give up": "Παραίτηση",
  "Confirm action": "Επιβεβαίωση ενέργειας",
  "If you leave, your current progress will be lost": "Αν φύγετε, η τρέχουσα πρόοδός σας θα χαθεί",
  History: "Ιστορικό",
  Article: "Άρθρο",
  Time: "Χρόνος",
  ...
  "Previewed Articles:": "Άρθρα σε προεπισκόπηση:",
  ...
  GachaAddict: {
    title: "Εθισμένος στη Gacha",
    description: "Επιλέξτε 1000 τυχαία άρθρα",
  },
  GachaOverlord: {
    title: "Άρχοντας της Gacha",
