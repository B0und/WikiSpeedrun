...
const About = () => {
  ...
  return (
    <>
      <h1 className="border-secondary-border border-b-[1px] font-serif text-3xl">{t({ id: "Wiki Speedrun Game" })}</h1>
      ...
      <h2 className="border-secondary-border border-b-[1px] text-2xl">{t({ id: "Features" })}</h2>
      <ul className="flex list-inside list-disc flex-col gap-2 pt-4 pb-8 pl-4">
        ...
        <li>
          ...
          <ul className="list-inside list-[circle]">
            <li className="pl-6">{t({ id: "actually stops while you are loading the next article" })}</li>
          </ul>
        </li>
